...
<body>
    <div class="wrapper container">
        ...
        <form action="<?php echo base_url().'singup/create_user'; ?>" method="POST" name="myForm" id="myForm"
            ...
            <div class="row">
                ...
                <?php echo (form_error('username') != "") ? 'is-invalid' : '';?>" name="username" id="userName"
                            placeholder="Input Username" value="<?php echo set_value('username')?>">
                        <?php echo form_error('username'); ?>
                        <span></span>
                    </div>

                    <div class="form-group">
                        <label for="lastname">Input Nama Belakang</label>
                        <input type="text" class="form-control 
                <?php echo (form_error('lastname') != "") ? 'is-invalid' : '';?>" name="lastname" id="lastName"
                            placeholder="Input Nama Belakang" value="<?php echo set_value('lastname')?>">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="firstname">Input Nama Depan</label>
                        <input type="text" class="form-control
                <?php echo (form_error('firstname') != "") ? 'is-invalid' : '';?>" name="firstname" id="firstName"
                            placeholder="Input Nama Depan" value="<?php echo set_value('firstname')?>">
                ...
                <?php echo (form_error('phone') != "") ? 'is-invalid' : '';?>" name="phone" placeholder="Input Kontak"
        ...
        <?php echo (form_error('address') != "") ? 'is-invalid' : '';?>"
            ...
            <p>Sudah ada akun? <a href="<?php echo base_url().'login/index';?>">Login Sekarang!</a></p>
        </form>
    </div>
