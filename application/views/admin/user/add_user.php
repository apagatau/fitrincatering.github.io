    ...
    <form action="<?php echo base_url().'admin/user/create_user'; ?>" method="POST"
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="firstname">Enter Nama Depan</label>
                    <input type="text" class="form-control
                    <?php echo (form_error('firstname') != "") ? 'is-invalid' : '';?>" name="firstname" id="firstName"
                        placeholder="Enter Nama Depan" value="<?php echo set_value('firstname')?>">
                    <?php echo form_error('firstname'); ?>
                    <span></span>
                </div>
                <div class="form-group">
                    <label for="lastname">Enter Nama Belakang</label>
                    <input type="text" class="form-control 
                    <?php echo (form_error('lastname') != "") ? 'is-invalid' : '';?>" name="lastname" id="lastName"
                        placeholder="Enter Nama Belakang" value="<?php echo set_value('lastname')?>">
