<div class="conatiner">
    <form action="<?php echo base_url() . 'admin/paket/create_paket'; ?>" method="POST" id="myForm" name="myForm" class="form-container mx-auto  shadow-container" style="width:80%" enctype="multipart/form-data">
        <h3 class="mb-3 text-center">Tambah Menu Paket</h3>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : ''; ?>" name="name" id="name" placeholder="Enter Paket name" value="<?php echo set_value('name'); ?>">
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : ''; ?>" id="price" name="price" placeholder="Enter Harga Rp" value="<?php echo set_value('price'); ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control my-2
                    <?php echo (form_error('about') != "") ? 'is-invalid' : ''; ?>" id="about" name="about" placeholder="Tentang" value="<?php echo set_value('about'); ?>">
                    <?php echo form_error('about'); ?>
                    <span></span>
                </div>
                <div class="form-group">
                    <label for="img">Gambar menu paket</label>
        ...
        <a href="<?php echo base_url() . 'admin/paket/index' ?>" class="btn btn-secondary">Back</a>
    </form>
</div>
<script>
