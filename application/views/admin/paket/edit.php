<div class="conatiner">
    <form id="myForm" action="<?php echo base_url().'admin/paket/edit/'.$paket['id'];?>" method="POST"
        class="form-container mx-auto  shadow-container" style="width:80%" enctype="multipart/form-data">
        <h3 class="mb-3 text-center">Edit Dish "<?php echo $paket['name']; ?>"</h3>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : '';?>" name="name" id="name"
                        placeholder="Enter dish name" value="<?php echo set_value('name', $paket['name']); ?>">
                    <span></span>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : '';?>" id="price" name="price"
                        placeholder="Enter Price" value="<?php echo set_value('price', $paket['price']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo (form_error('about') != "") ? 'is-invalid' : '';?>" id="about" name="about"
                        placeholder="About" value="<?php echo set_value('about', $paket['about']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php if($paket['img'] != "" && file_exists('./public/uploads/dishesh/thumb/'.$paket['img'])) { ?>

                    <img src="<?php echo base_url().'public/uploads/dishesh/thumb/'.$paket['img'];?>">
